...
class StorageImpl {
  ...
  Future<bool> _exists() async {
    return (localStorage.getItem(fileName) != null) ? true : false;
  }
  ...
  Map<String, String> getLocalStorageAsMap() {
  ...
  Future<void> _readFromStorage() async {
    var allLocalStorage = getLocalStorageAsMap();
    final dataFromLocal = allLocalStorage.entries.firstWhereOrNull((value) {
